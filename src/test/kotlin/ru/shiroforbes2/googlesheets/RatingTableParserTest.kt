...
class RatingTableParserTest {
  ...
  @Test
  fun `parse episode`() =
    assertContentEquals(oneEpisodeRating(), RatingTableParser().parse(oneEpisodeTable()))

  private fun oneEpisodeTable(): List<List<String>> = listOf(
    listOf("", "", "", "", "1", "1", "2"),
    listOf("", "", "", "", "", "", ""),
    listOf("", "", "", "", "2", "3", "4"),
    listOf("", "", "", "", "", "", ""),
  ...
  private fun oneEpisodeRating(): List<List<Rating>> = listOf(
    listOf(
