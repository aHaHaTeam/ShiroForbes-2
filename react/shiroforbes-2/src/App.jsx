...
function App() {
    ...
    return (
        <SidebarArea>
            <main className="w-full flex flex-col items-center justify-center min-h-screen bg-background">
                <div className="w-full flex justify-start">
                    <SidebarTrigger/>
                </div>
                <div className="w-full flex rounded-2xl items-center gap-4 p-4 bg-gray-100 justify-center">
